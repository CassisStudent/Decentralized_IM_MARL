...
target_file = event_files[3] # We pakken hetzelfde bestand als voorheen
...
ax_ext = fig.add_subplot(grid[2, :]) # Grote balk onderaan voor de echte score!
...
ax_ir.set_title('Intrinsic Reward Raw Mean (Variance)', fontweight='bold')
...
plt.savefig("marl_validation_with_extrinsic.png", dpi=300, bbox_inches='tight')
